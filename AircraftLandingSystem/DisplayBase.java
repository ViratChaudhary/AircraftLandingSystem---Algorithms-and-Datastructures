...
abstract class DisplayPartiallySortedBase {
     ...
     *
     * @param scheduleFilename list of lines containing sorted schedule of planes
     *                 in CSV format, no header
     * @param extraPlanesFilename list of lines containing unsorted extra planes
     *                    in CSV format, no header
     */
    public DisplayPartiallySortedBase(String[] scheduleFilename,
            String[] extraPlanesFilename) {
        this.schedule = CSVReader.readPlanesFromLines(scheduleFilename);
        this.extraPlanes = CSVReader.readPlanesFromLines(extraPlanesFilename);
    }
